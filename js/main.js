...
$(function() {
    ...
    let pecans = new Product("Fisher Chef's Naturals Pecan Halves", "Nuts", 129, "../assets/products/cat_nuts/pecans.jpeg", id++, "Ingredients: Pecans.", 0);
    let almonds = new Product("Great Value Whole Natural Almonds", "Nuts", 45, "../assets/products/cat_nuts/almonds.jpeg", id++, "Ingredients: ALMONDS", 0);
